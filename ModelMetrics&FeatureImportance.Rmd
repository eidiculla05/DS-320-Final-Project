...
```{r}
### RF Metrics 
#Model 1(Medical + Environmental factors)
# ------------------------------
# METRICS FOR ASTHMA MODEL
# ------------------------------
...
final_metrics <- rbind(asthma_metrics, medical_metrics)
final_metrics
...
### XGBoost Model
```{r}
# ---- Metrics for Medical + Environmental ----
...
combined_xgb_metrics <- rbind(
  metrics_xgb_asthma,
  metrics_xgb_medical
)

combined_xgb_metrics
